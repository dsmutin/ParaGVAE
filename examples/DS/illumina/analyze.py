#!/usr/bin/env python3
"""Where the Illumina GCN puts a contig in the wrong majority genome."""
...
def main() -> None:
    ...
    graph = load_vaegbin("illumina")
    if not graph["vae_equals_raw"]:
        raise RuntimeError("Illumina was expected to store the same matrix as VAE and raw features")
